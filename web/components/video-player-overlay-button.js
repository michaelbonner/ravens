        ...
        >
          ...
          {leftReelText && rightReelText && (
            <div className="absolute inset-0 mx-auto flex items-center justify-center">
              <div
                className={classNames(
                  "w-fit flex items-center justify-center gap-6 px-8 py-4 border-2 border-gold text-3xl tracking-widest font-bold uppercase",
                  "lg:text-5xl"
                )}
              >
                <div>{leftReelText}</div>
                <Image
                  width={30}
                  height={40}
                  alt="X icon"
