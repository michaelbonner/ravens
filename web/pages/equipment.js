        ...
        <div>
          ...
          <section className="mt-16">
            <header className="relative mb-12">
              <Image 
                src={urlForSanitySource(equipment.aerialImage).width(450).height(300).url()}
                layout="intrinsic"
                width="450"
                height="300"
              />
            ...
            <div className="md:px-32 mb-20">
              <h2 className="font-bold mt-12 mb-3 text-2xl uppercase">{equipment.aerialContentHeading}</h2>
              ...
              <table className="min-w-full mt-8 ">
                ...
                {lensesTableRows.map((row) => {
                  return (<tr key={row._key} >
                    <td  className="pb-3 pt-3 text-xs text-left">{row.lenses}</td>
                    <td  className="pb-3 pt-3 text-xs">{row.weight}</td>
                    <td  className="pb-3 pt-3 text-xs">{row.remPayload}</td>
                    <td  className="pb-3 pt-3 text-xs">{row.extPayload}</td>
                  </tr>)
            ...
            <div className="md:px-28 lg:px-60">
              <p className="text-left text-sm pb-6"><span className="font-bold">REM PAYLOAD:</span> {equipment.remContent}</p>
              <p className="text-left text-sm"><span className="font-bold">EXT PAYLOAD:</span> {equipment.extContent}</p>
            </div>
          ...
          <section className="mb-16">
            <header className="relative mb-12">
              <Image 
                src={urlForSanitySource(equipment.vehicleImage).width(450).height(300).url()}
                layout="intrinsic"
                width="450"
                height="300"
              />
            ...
            <div className="md:px-32">
              <h2 className="font-bold mb-3 text-2xl uppercase">{equipment.vehicleContentHeading}</h2>
          ...
          <section className="">
            <header className="relative mb-12">
              <Image 
                src={urlForSanitySource(equipment.highSpeedImage).width(450).height(300).url()}
                layout="intrinsic"
                width="450"
                height="300"
              />     
            ...
            <div className="md:px-32 mt-12">
              <h2 className=" mb-3 font-bold text-2xl uppercase">{equipment.highSpeedContentHeading}</h2>
